...
const styles = StyleSheet.create({
  ...
  pos1SubText: { position: 'absolute', top: 110, left: '50%', marginLeft: -75, color: '#6b7280', fontSize: 14, fontWeight: '500', width: 150, textAlign: 'center', zIndex: 10, alignSelf: 'center' },
