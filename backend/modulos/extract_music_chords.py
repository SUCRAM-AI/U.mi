...
def extract_chords(job_result):
    ...
    # Não salvar em arquivo quando usado como módulo
    # Se necessário, pode ser salvo pelo chamador
    if not normalized:
...
# Código de teste removido - use apenas as funções main() ou extract_chords()